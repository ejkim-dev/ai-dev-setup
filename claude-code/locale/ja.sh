...
MSG_STEP_PACKAGES="パッケージインストール（git, node, ripgrep, tmux, フォント）"
...
MSG_TERMINAL_APPLIED="Terminal.app 'Dev' プロファイル適用完了"
MSG_TERMINAL_RESTART_HINT="新しいターミナルウィンドウを開くとDevテーマが適用されます"
MSG_ITERM2_PROFILE_APPLIED="iTerm2 Dev プロファイル適用済み"
MSG_ITERM2_PROFILE_HINT="iTerm2を起動 → Preferences → Profiles → Dev を選択"
