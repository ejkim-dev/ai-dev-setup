...
MSG_NODE_INSTALL_ASK_WIN="wingetでNode.jsをインストールしますか？"
...
MSG_ATL_PATH="プロジェクトパス（例: ~/projects/my-app）: "
...
# Windows-specific
MSG_WINGET_CHECK="winget（パッケージマネージャー）確認"
