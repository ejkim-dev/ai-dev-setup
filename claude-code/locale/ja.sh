...
MSG_WS_TREE_DOC="ドキュメント（getting-started、claude-guide）"
MSG_WS_TREE_SETUP_LANG="セットアップ用言語リソース（一時的）"
...
MSG_WS_DOC_DONE="ドキュメントのコピー完了: getting-started, claude-guide"
...
MSG_PROJ_TRY_AGAIN="もう一度入力するか、Enterでスキップしてください。"
...
MSG_MCP_INSTALLING_COUNT="%d個のMCPサーバーを設定中..."
MSG_MCP_PROJECT_ASK_EACH="'%s' プロジェクトにMCPサーバーを追加しますか？"
...
MSG_PHASE2_OPT_YES="はい、続行"
MSG_PHASE2_OPT_NO="いいえ、後で"
MSG_PHASE2_RESTART_WARN="⚠️  Phase 2 のためにターミナルの再起動が必要です"
MSG_PHASE2_RESTART_REASON="   （更新されたPATHとシェル設定を読み込むため）"
MSG_PHASE2_OPEN_TERM_ASK="新しいターミナルを開いてPhase 2を開始しますか？"
MSG_PHASE2_OPEN_OPT_YES="はい、新しいターミナルを開く"
MSG_PHASE2_OPEN_OPT_NO="いいえ、後で手動で実行"
MSG_PHASE2_OPENING="🚀 新しいターミナルを開いています..."
MSG_PHASE2_OPENED="✅ 新しいターミナルでPhase 2セットアップが開始されました"
MSG_PHASE2_CLOSE_INFO="ℹ️  Phase 2が開始されたら、このウィンドウを閉じても構いません"
MSG_PHASE2_MANUAL="💡 後で新しいターミナルでPhase 2を実行："
