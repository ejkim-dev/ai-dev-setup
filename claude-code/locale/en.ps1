...
$MSG_CLAUDE_INSTALL_CMD = "  Visit: https://claude.ai/code"
$MSG_CLAUDE_RESTART_TERMINAL = "Please restart PowerShell and re-run this script."
$MSG_CLAUDE_INSTALL_FAILED = "Installation failed or Claude Code not detected"
$MSG_CLAUDE_CHECK_HEADER = "Please check:"
$MSG_CLAUDE_CHECK_NPM = "1. Internet connection"
$MSG_CLAUDE_CHECK_INTERNET = "2. System permissions"
$MSG_CLAUDE_CHECK_PERMISSIONS = "3. Disk space"
$MSG_CLAUDE_TRY_MANUAL = "Install manually: https://claude.ai/code → Follow official setup guide"
...
$MSG_NPM_NOT_FOUND = "npm not found. Optional if Claude Code is already installed."
...
$MSG_WINTERMINAL_PARSE_FAIL = "Failed to parse settings.json (JSONC format not fully supported). Theme not applied."
$MSG_WINTERMINAL_BACKUP_RESTORED = "Original settings restored from backup."
