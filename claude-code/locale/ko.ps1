...
$MSG_CLAUDE_INSTALL_CMD = "  방문: https://claude.ai/code"
$MSG_CLAUDE_RESTART_TERMINAL = "PowerShell을 재시작하고 이 스크립트를 다시 실행해주세요."
$MSG_CLAUDE_INSTALL_FAILED = "설치 실패 또는 Claude Code 감지 안 됨"
$MSG_CLAUDE_CHECK_HEADER = "다음을 확인해주세요:"
$MSG_CLAUDE_CHECK_NPM = "1. 인터넷 연결"
$MSG_CLAUDE_CHECK_INTERNET = "2. 시스템 권한"
$MSG_CLAUDE_CHECK_PERMISSIONS = "3. 디스크 공간"
$MSG_CLAUDE_TRY_MANUAL = "수동 설치: https://claude.ai/code → 공식 설치 가이드 참조"
...
$MSG_NPM_NOT_FOUND = "npm을 찾을 수 없습니다. Claude Code가 이미 설치되어 있으면 선택 사항입니다."
