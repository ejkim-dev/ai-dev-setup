...
MSG_NPM_NOT_FOUND="npm not found. Node.js and npm are optional if Claude Code is already installed."
...
MSG_WS_TREE_DOC="Documentation (getting-started, claude-guide)"
MSG_WS_TREE_SETUP_LANG="Setup language resources (temporary)"
...
MSG_WS_DOC_DONE="Documentation copied: getting-started, claude-guide"
...
MSG_PROJ_TRY_AGAIN="Please try again or press Enter to skip."
...
MSG_MCP_INSTALLING_COUNT="Configuring %d MCP server(s)..."
MSG_MCP_PROJECT_ASK_EACH="Add MCP servers to '%s' project?"
...
MSG_MCP_INSTALLING_PREFIX="Adding %s..."
...
MSG_PHASE2_RESTART_WARN="⚠️  Terminal restart required for Phase 2"
...
MSG_PHASE2_OPENING="🚀 Opening new terminal..."
MSG_PHASE2_OPENED="✅ New terminal opened with Phase 2 setup"
MSG_PHASE2_CLOSE_INFO="ℹ️  You can close this window after Phase 2 starts"
MSG_PHASE2_MANUAL="💡 Run Phase 2 later in a new terminal:"
