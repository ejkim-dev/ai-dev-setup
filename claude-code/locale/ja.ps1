...
$MSG_CLAUDE_INSTALL_CMD = "  訪問: https://claude.ai/code"
$MSG_CLAUDE_RESTART_TERMINAL = "PowerShellを再起動してこのスクリプトを再実行してください。"
$MSG_CLAUDE_INSTALL_FAILED = "インストール失敗またはClaude Code検出なし"
$MSG_CLAUDE_CHECK_HEADER = "以下を確認してください："
$MSG_CLAUDE_CHECK_NPM = "1. インターネット接続"
$MSG_CLAUDE_CHECK_INTERNET = "2. システム権限"
$MSG_CLAUDE_CHECK_PERMISSIONS = "3. ディスク空き容量"
$MSG_CLAUDE_TRY_MANUAL = "手動インストール: https://claude.ai/code → 公式セットアップガイドを参照"
...
$MSG_NPM_NOT_FOUND = "npmが見つかりません。Claude Codeがすでにインストールされている場合はオプションです。"
