...
MSG_PROJ_TRY_AGAIN="다시 입력하거나 Enter로 건너뛰세요."
...
MSG_MCP_INSTALLING_COUNT="%d개 MCP 서버 설정 중..."
MSG_MCP_PROJECT_ASK_EACH="'%s' 프로젝트에 MCP 서버를 추가하시겠습니까?"
...
MSG_MCP_INSTALLING_PREFIX="%s 추가 중..."
...
MSG_GIT_CONFIG_NOW="지금 설정"
MSG_GIT_CONFIG_LATER="나중에"
MSG_GIT_NAME="이름: "
MSG_GIT_EMAIL="이메일: "
